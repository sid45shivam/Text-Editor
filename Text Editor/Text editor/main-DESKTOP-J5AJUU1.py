...
import os
from tkinter.constants import CURRENT, NONE, UNDERLINE
...
# FILE NEW buttton functionality
url = ''
...
# file open button functionality

def open_file(event=None):
    global url
    url = filedialog.askopenfilename(initialdir=os.getcwd(), title="Select Files", filetypes=(('Text Files', "*.txt"),('All files', '*.*')))
    try:
...
# file exit button functionality
...
# View icons and cheackbutton commands
...
# color theme loop
# we are going to learn adding change theme command
def change_theme():
